  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-800 text-white">
      ...
      <section className="relative h-[60vh] flex items-center justify-center overflow-hidden">
        <Image
          src="/images/quicksite.jpg"
          alt="Quick Start Websites"
          fill
          priority
        ...
        >
          ...
          <p className="text-lg text-gray-300">
            Launch fast with a professional site built on proven templates.
          </p>
        </motion.div>
      </section>
      ...
      <section className="max-w-6xl mx-auto px-6 py-24 grid md:grid-cols-2 gap-16">
        ...
        >
          ...
          <p className="text-gray-300 leading-relaxed mb-8">
            We provide professionally designed, template-based websites that can
            be quickly customized and launched, giving you a strong online
            presence without the wait.
          </p>
