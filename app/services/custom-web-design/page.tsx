      ...
      <section className="relative h-[60vh] flex items-center justify-center overflow-hidden">
        ...
        >
          ...
          <p className="text-lg text-gray-300">
            Bespoke websites crafted to elevate your brand and convert visitors
            into customers.
          </p>
        </motion.div>
      </section>
      ...
      <section className="max-w-6xl mx-auto px-6 py-24 grid md:grid-cols-2 gap-16">
        ...
        >
          ...
          <p className="text-gray-300 leading-relaxed mb-8">
            We design and build fully custom websites from the ground up,
            ensuring your digital presence reflects your brand identity and
            drives measurable results.
          </p>

          <ul className="space-y-4 text-gray-200">
            <li>• Brand-first UI/UX design</li>
            <li>• Conversion-optimized layouts</li>
            <li>• Fully responsive development</li>
            <li>• Performance & SEO-ready builds</li>
          </ul>
        </motion.div>
